...
import 'widgets/doc_groub_header.dart';

class DocGroubDetails extends StatefulWidget {
  const DocGroubDetails({super.key});

  @override
  State<DocGroubDetails> createState() => _DocGroubDetailsState();
}

class _DocGroubDetailsState extends State<DocGroubDetails>
          ...
          body: Stack(
            children: [
              ...
              Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  DocGroubHeader(onChangeBackground: _pickBackgroundImage),
                  Expanded(
