class FavlistModel {
  late final List<Provicers> provicers;

  FavlistModel.fromJson(Map<String, dynamic> json) {
    if (json['provicers'] != null) {
      provicers = <Provicers>[];
      json['provicers'].forEach((v) {
        provicers.add(Provicers.fromJson(v));
      });
    }
  }
}
...
class Provicers {
  ...
  Provicers.fromJson(Map<String, dynamic> json) {
    id = json['id'];
